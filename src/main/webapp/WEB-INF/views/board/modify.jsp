                                ...
                                <form action="/board/modify" method="POST">
                                    ...
                                    <table class="table write-table">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="select-box" name="category">
                                                        ...
                                                        <option value="KOREAN_FOOD" ${restaurant.category=='KOREAN_FOOD'
                                                            ? 'selected' : '' }>한식</option>
                                                        <option value="CHINA_FOOD" ${restaurant.category=='CHINA_FOOD'
                                                            ? 'selected' : '' }>중식</option>
                                                        <option value="ITALY_FOOD" ${restaurant.category=='ITALY_FOOD'
                                                            ? 'selected' : '' }>이태리식</option>
                                                        <option value="JAPAN_FOOD" ${restaurant.category=='JAPAN_FOOD'
                                                            ? 'selected' : '' }>일식</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="6"><textarea name="menus" cols="30"
                                                        rows="15">${restaurant.menus}</textarea>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
